const db = {
  ...
  pneumonoultramicroscopicsilicovolcanoconiosis: { chunks: ['What', 'I',"Dont","Know","How","To","Pronounce","This"], phones: ['IDK', 'What',"This","is",] },
   psx: { chunks: ['I', 'Play',"That","Game"], phones: ['P', 'S',"X"] },
};
export default db;